...
public class MemberController {
	...
	@Autowired // 의존성 주입(DI)
	private com.kh.finalproject.service.MemberService service;
	...
	public String login(/* @ModelAttribute */ com.kh.finalproject.dto.Member inputMember, RedirectAttributes ra, Model model,
			@RequestParam(value = "saveId", required = false) 
	String saveId, HttpServletResponse resp) throws Exception{

		// 로그인 서비스 호출

		com.kh.finalproject.dto.Member loginMember = service.login(inputMember);
	 ...
	 */
	@PostMapping("signup")
	public String signup(@ModelAttribute com.kh.finalproject.dto.Member inputMember, @RequestParam("memberAddress") String[] memberAddress,
	...
	public List<com.kh.finalproject.dto.Member> selectMemberList() {
